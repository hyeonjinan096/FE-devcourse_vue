...
module.exports = {
  ...
  output: {
    ...
    publicPath: '/', //상대 경로를 절대 경로로 만들어서 새로고침을 해도 화면에 렌더링되도록 한다.
    clean: true,
  },
  module: {
    rules: [
      ...
      {
        test: /\.s?css$/,
        use: ['vue-style-loader', 'css-loader', 'sass-loader'], //먼저 실행되야하는 것을 나중에 기입
      },
    ],
  },
  plugins: [
  ...
  devServer: {
    historyApiFallback: true, //예시로 '/about'페이지 요청이 들어오면 '/index.html'로 리다이랙트 시켜준다.
